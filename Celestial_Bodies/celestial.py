...
app = Flask(__name__)
app.config['UPLOAD_FOLDER'] = '/Users/krishna/Desktop/Celestial_Bodies/UPLOAD_FOLDER/' # the media directory from where it can be accessed (should be in the same repository as the code)
